// Example 10.1	: manual sleep+waitqueue
//		prepare_to_wait()
//		:  main.c
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,18,0)
	// sleep_on and variants are removed - at this time
	// sleep instead of wakeup.  see next example for wakeup
	sleep_on_timeout(usrsp->proc_hello_wqh,10*HZ);	
#else
  msleep(1000);
#endif
	...
	printk(KERN_ALERT "2470:10.1: writing message!\n");
...
static void my_exit (void) {
	...
	if (proc_mydev)
        ...
        // module exit message
        printk(KERN_ALERT "2470:10.1: main destroyed!\n");
}
